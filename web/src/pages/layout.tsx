...
function PageLayout({ children }: { children: ReactNode }) {
  ...
  function onClickMenuItem(key) {setSelectedKeys([key])}
  function toggleCollapse() {setCollapsed((collapsed) => !collapsed)}
  ...
  function renderRoutes(locale) {
    ...
    return function travel(_routes: IRoute[], level, parentNode = []) {
      return _routes.map((route) => {
        ...
        const titleDom = (<>{iconDom} {locale[route.name] || route.name}</>);
  ...
  return (
    <Layout className={styles.layout}>
      ...
      {userLoading ? (
        ...
        <Layout>
          {showMenu && (
            <Sider className={styles['layout-sider']} width={menuWidth} collapsed={collapsed}
              onCollapse={setCollapsed} trigger={null} collapsible breakpoint="xl" style={paddingTop}
            >
              <div className={styles['menu-wrapper']}>
                <Menu collapse={collapsed} onClickMenuItem={onClickMenuItem} selectedKeys={selectedKeys} openKeys={openKeys}
